                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="avatar-container">
                                            <img src="../../assets/global/img/avatars/avatar-lg.png"
                                                 alt="Admin Avatar" class="img-fluid">
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        <h4>Jane Doe</h4>
                                        <p class="detail-row"><i class="icon-fa icon-fa-map-marker"></i> New York ,
                                            United States</p>
                                        <p class="detail-row"><i class="icon-fa icon-fa-birthday-cake"></i>
                                            September 7, 1991</p>
                                        <p class="detail-row"><i class="icon-fa icon-fa-wrench"></i> UI Designer /
                                            Pro Model</p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                        ...
                                        <ul class="media-list activity-list">
                                                ...
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object img-thumbnail"
                                                             src="../../assets/global/img/avatars/avatar1.png"
                                                             alt="Generic placeholder image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Shane White <span>just posted an update</span>
                                                    </h4>
                                            ...
                                            <li class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object img-thumbnail"
                                                             src="../../assets/global/img/avatars/avatar2.png"
                                                             alt="Generic placeholder image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Adam David <span>just became friends with</span>
                                                        Shane White </h4>
                                ...
                                <ul class="media-list activity-list">
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <small>Today at 3.50pm</small>
                                            <p class="mt-2">"When you have children, you always have family. They
                                                will always be your priority, your responsibility.
                                                And a man, a man provides. And he does it even when he's not
                                                appreciated or respected or even loved. He simply bears up and he
                                                does it. Because he's a man."</p>
                                        </div>
                                    </li>
                                    <li class="media">
                                        <div class="media-left">
